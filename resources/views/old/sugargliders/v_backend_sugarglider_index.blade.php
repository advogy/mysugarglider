        ...
        <table class="be-table">
            ...
            <tbody>
                @forelse ($sugargliders as $sg)
                    <tr>
                        <td>
                            <div class="w-11 h-11 rounded-xl overflow-hidden bg-sage-100 flex-shrink-0">
                                @if ($sg->gambar)
                                    <img src="{{ asset('/upload/sugargliders/' . $sg->gambar) }}"
                        ...
                        <td class="text-right">
                            <div class="flex items-center justify-end gap-2">
                                ...
                                <button type="button"
                                        onclick="confirmDelete('{{ route('sugarglider.destroy', $sg->id) }}', '{{ $sg->nama }}')"
                                        class="btn-delete">
...
<div id="delete-modal" class="fixed inset-0 z-50 hidden items-center justify-center p-4" style="background:rgba(0,0,0,0.4)">
    <div class="bg-white rounded-3xl shadow-hover max-w-sm w-full p-6">
        ...
        <p class="text-bark-muted text-sm text-center mb-2">
            Anda akan menghapus:
        </p>
        ...
        <div class="flex gap-3">
            ...
            <form id="delete-form" method="POST" class="flex-1">
                ...
                <button type="submit" class="w-full inline-flex items-center justify-center gap-2
                                             bg-red-500 text-white px-4 py-3 rounded-full font-bold text-sm
