...
<div class="flex items-center justify-center min-h-[60vh]">
    <div class="text-center max-w-sm">
        ...
        <p class="text-bark-muted text-sm mb-6">Belum ada sugar glider yang dibuka untuk adopsi. Ubah status koleksi ke "Adopsi" untuk memulai.</p>
        <a href="{{ route('collection.index') }}" class="btn-create">
            <i class="bi bi-grid-3x3-gap"></i> Lihat Koleksi
        </a>
    </div>
</div>
