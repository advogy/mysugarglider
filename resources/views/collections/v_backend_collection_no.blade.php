...
<div class="flex items-center justify-center min-h-[60vh]">
    <div class="text-center max-w-sm">
        ...
        <h3 class="text-xl font-bold text-bark mb-2">Belum Ada Penempatan</h3>
        <p class="text-bark-muted text-sm mb-6">Tempatkan sugar glider pertama Anda ke kandang untuk mulai menggunakan fitur ini.</p>
